...
// WiFi Credentials 
const char* ssid = "xie10";           
const char* password = "123456789";  
const char* server_url = "http://192.168.137.180:8000";
...
void loop() {
  ...
  if (content.substring(1) == "39 3D 9E B8")  //change UID of the card that you want to give access
  {
    ...
    values["itemname"] = "RedBull";
    values["price"] = 100;

    // values["imgLink"] = "https://m.media-amazon.com/images/I/51Bp30CR3IL._AC_UL640_QL65_.jpg";
  ...
  else if (content.substring(1) == "87 04 D5 60")  //change UID of the card that you want to give access
  {
    ...
    JsonObject& values = jsonBuffer.createObject();
    values["itemname"] = "Kellogs Cornflakes";
    values["price"] = 50;
    // values["imgLink"] = "https://m.media-amazon.com/images/I/91KZBHX-d-L._AC_UY436_QL65_.jpg";
  ...
  else if (content.substring(1) == "05 D0 7F 22")  //change UID of the card that you want to give access
  {
    ...
    JsonObject& values = jsonBuffer.createObject();
    values["itemname"] = "Nestle Coffee";
    values["price"] = 30;
    // values["imgLink"] = "https://m.media-amazon.com/images/I/71DpoMAG6pL._AC_UL640_QL65_.jpg";
